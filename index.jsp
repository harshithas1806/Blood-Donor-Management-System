...
<h1>Blood Donor <span>Management System</span></h1>
</div>
...
<div class="content">
 <h1 style="text-align:center">Donate Blood Save Life</h1>

 <p style="text-align:justify;color:black;font-size:18px;">
 <br><br>
 A blood donor is a center where blood gathered as a result of blood donation is stored and preserved for later use in blood transfusion. The term "blood donor" typically refers to a division of a hospital where the storage of blood product occurs and where proper testing is performed (to reduce the risk of transfusion related adverse events). However, it sometimes refers to a collection center, and indeed some hospitals also perform collection.
 </p>
 <p>&nbsp;</p>
 <img src="images/Blood3.jpg"  style="width:150px;height:150px"></img>
</div>
</div>
<div class="footer">
